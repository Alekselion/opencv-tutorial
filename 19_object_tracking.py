...
while cap.isOpened():
    ...
    if success:
        cv2.putText(frame, "1. Press 's' to select object for tracking.", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 255), 2)
        cv2.imshow("ROI selector", frame)
        if cv2.waitKey(30) & 0xff == ord("s"):
            cv2.putText(frame, "2. Select tracking object and press 'enter'.", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 255), 2)
